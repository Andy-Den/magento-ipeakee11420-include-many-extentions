...
class Balance_ConfigurableSimplePriceOverride_Model_Catalog_Resource_Eav_Mysql4_Product_Indexer_Price extends Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Indexer_Price {
    ...
    private function getChildIdsByParent($parentId) {
        ...
        $select = $read->select()
                ...
                ->join(
                        ...
                        array('pr' => $this->getTable('catalog/product_relation')), 'pr.child_id=p.entity_id', array('p.type_id'))
    ...
    private function getProductTypeById($id) {
        ...
        $select = $read->select()
                ...
                ->join(
                        array('p' => $this->getTable('catalog/product')), 'pr.parent_id=p.entity_id', array('p.type_id'))
