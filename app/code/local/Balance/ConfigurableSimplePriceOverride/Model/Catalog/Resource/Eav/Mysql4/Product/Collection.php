...
class Balance_ConfigurableSimplePriceOverride_Model_Catalog_Resource_Eav_Mysql4_Product_Collection extends Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Collection {
    ...
    protected function _productLimitationJoinPrice() {
        ...
        if (!isset($fromPart['price_index'])) {
            ...
            $this->getSelect()->join(
                    array('price_index' => $this->getTable('catalog/product_index_price')), $joinCond, array('indexed_price' => $indexedExpr, 'price', 'final_price', 'minimal_price' => $minimalExpr, 'min_price', 'max_price', 'tier_price'));
        } else {
