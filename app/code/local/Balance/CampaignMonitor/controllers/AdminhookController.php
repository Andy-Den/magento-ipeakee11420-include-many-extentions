...
class Balance_CampaignMonitor_AdminhookController extends Mage_Adminhtml_Newsletter_SubscriberController
{

    public function massUnsubscribeAction()
    {
        die('come herer');
        Mage::log("Balance_CampaignMonitor: massUnsubscribeAction");
        ...
        if (!is_array($subscribersIds)) {
            ...
            try {
                ...
                try {
                    ...
                    Mage::log(
                        "Balance_CampaignMonitor: Error connecting to CampaignMonitor server: " . $e->getMessage()
                    );
