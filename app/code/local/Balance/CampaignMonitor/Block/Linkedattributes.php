 ...
 */
class Balance_CampaignMonitor_Block_Linkedattributes
    extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->setTemplate('balance/campaignmonitor/system/config/form/field/array_dropdown.phtml');
    ...
    protected function _renderCellTemplate($columnName)
    {
        ...
        if ($columnName == 'magento') {
            ...
            return '<input type="text" name="' . $inputName . '" value="#{' . $columnName . '}" ' . ($column['size'] ?
                'size="' . $column['size'] . '"' : '') . '/>';
        }
