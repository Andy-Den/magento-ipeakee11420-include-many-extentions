...
/**
 * Override  change extends and make custom label
 *
 * @category  Milandirect
 * @package   Milandirect_Onsale
 * @author    Balance Internet Team <dev@balanceinternet.com.au>
 * @copyright 2016 Balance
 */
class Milandirect_Onsale_Block_Product_View_Label extends AW_Onsale_Block_Product_Label
{
    protected $_label = null;
    protected $_product = null;
    protected $_customLabel = 0;
    ...
    public function setUseCustom($custom = 0)
    {
        $this->_customLabel = $custom;
    }
    ...
    {
        if ($this->_customLabel != 0) {
            return parent::getImageSizeHtml();
        }
