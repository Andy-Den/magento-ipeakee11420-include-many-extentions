 ...
 *
**/
class Sebastian_Export_Adminhtml_Export_IndexController extends Mage_Adminhtml_Controller_Action
{

    protected function _isAllowed()
    {
        return Mage::getSingleton('admin/session')->isAllowed('admin/sales/export');
    }
    ...
    public function getAction() {
      ...
      if (!empty($file) && $filename != '') {
        if (file_exists($file)) {
          ...
          $this->_redirect('adminhtml/export_index/index');
        }
      } else {
    ...
    public function deleteAction() {
      if ($id = $this->getRequest()->getParam('export_id')) {
        ...
        if (!$export) {
          ...
          $this->getResponse()->setRedirect($this->getUrl('adminhtml/export_index/index'));
          return;
        }
