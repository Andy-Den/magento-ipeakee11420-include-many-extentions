// Remove ajax catalog from tablet theme
 ...
 // Check setLocation is add product to cart
	...
	var ajaxcatalog	=	function(){
		...
		function showloading(){
			img	=	"<div id='ajaxcatalogsending' style='width:100%;height:68px;text-align:center;'><img style='display:inline;' src='"+catalogSkinurl+"frontend/base/default/images/opc-ajax-loader.gif'/></div>";
			...
			onSend:function(url,typemethod,page){
				...
				new Ajax.Request(url,
					...
					onComplete:function(cp){
                        ...
                        /*Add uniform for toolbar*/
                        $jq("select:not(.super-attribute-select), input[type='checkbox'], input[type='radio']").uniform();
					}
