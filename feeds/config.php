...
$mageFilePath = $localXmlFilename = $base_path . DIRECTORY_SEPARATOR . $dir_name . DIRECTORY_SEPARATOR .'app' . DIRECTORY_SEPARATOR . 'Mage.php';

$mediaFolderPath = $localXmlFilename = $base_path . DIRECTORY_SEPARATOR . $dir_name . DIRECTORY_SEPARATOR .'media';