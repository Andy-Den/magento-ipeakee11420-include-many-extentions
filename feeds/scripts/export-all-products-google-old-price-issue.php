...
*******************************************/
	...
	$date = date("j-n-Y");
	$file_to_write = '/var/www/milandirect/feeds/google_products_'.$storeCode.'.csv';
	...
	*******************************************/
	...
	$data = array("id","sku","product_type","condition","shipping","google_product_category","brand","availability","title", "link", "image link", "price","description","weight");
							...
							if($db->affected_rows>0) {
								...
								elseif($avalue == 'special_price') {
									if($rowAtt['value'] != null && $visibility !='3'){
										...
										$productprice = '';
										$productprice = getBasePrice($db,$entity_id,$attributeDetailSpecialPrice);
									}
									$attributeValue  = $productprice;
