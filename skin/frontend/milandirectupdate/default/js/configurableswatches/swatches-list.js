...
var ConfigurableSwatchesList = {
    ...
    handleSwatchSelect: function($swatch)
    {
        ...
        jQuery('#product_addtocart_form'+productId +' .btn-cart').removeAttr('disabled');
        if($swatch.hasClass('not-available')) {
            jQuery('#product_addtocart_form'+productId +' .btn-cart').attr('disabled','disabled')
        }
    }
}
