...
Checkout.prototype = {
    ...
    gotoSection: function(section)
    {
        ...
        if(section == 'payment') {
            review = new Review(BASE_URL_SECURE + 'checkout/onepage/saveOrder', BASE_URL + 'checkout/onepage/success'); 
...
//            }
    ...
    */
    ...
    callCartReview: function(){
        try{
            review = new Review(BASE_URL_SECURE + 'checkout/onepage/saveOrder', BASE_URL + 'checkout/onepage/success'); 
            review.getReviewContent(BASE_URL + 'awmobile/onepage/cart');
        } catch(err){
            alert(err.message);
        }
    }
